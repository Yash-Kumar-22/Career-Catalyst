  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div className="flex flex-col justify-between xl:w-5/12">
        ...
        <div className="sm:text-center lg:py-12 lg:text-left xl:py-24">
          ...
          <h1 className="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">
            Revolutionary way to give an Interview.
          </h1>
      ...
      <div className="h-40 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:h-auto xl:w-5/12">
        <img
          src="https://i0.wp.com/apeejay.news/wp-content/uploads/2023/10/281023-10-most-read-books-Feature.jpg?fit=569%2C509&ssl=1"
          loading="lazy"
